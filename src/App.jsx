...
const ArtFrames = lazy(() => import('./pages/ArtFrames'));
const LockStyles = lazy(() => import('./pages/LockStyles'));
...
const TITLES = {
  ...
  '/payment': '收款追蹤', '/finance': '財務管理', '/accessories': '五金配件', '/colors': '色卡管理', '/panelstyles': '門板樣式', '/artframes': '藝術框管理', '/lockstyles': '門鎖樣式', '/staff': '員工帳號',
  '/aiprompt': 'AI 提示詞管理',
};
          ...
          <ErrorBoundary>
            <Suspense fallback={<PageLoader />}>
              <Routes>
                ...
                <Route path="/artframes" element={<ArtFrames />} />
                <Route path="/lockstyles" element={<LockStyles />} />
